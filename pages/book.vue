<template>
  ...
  <div class="flex flex-col gap-4 mb-6">
    <div class="collapse form-control">
      <input type="checkbox" :checked="true" class="collapse-title checkbox" />
      <input type="checkbox" :checked="true" class="collapse-title checkbox" />
      <input type="checkbox" :checked="true" class="collapse-title checkbox" />
      <input type="checkbox" :checked="true" class="collapse-title checkbox" />
    </div>
    ...
    <div class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div class="mb-4">
          ...
          <v-date-picker borderless v-model="date" mode="date" class="custom-picker" is-required :min-date='new Date()'
            locale="es" color="red" transparent :disabled-dates="disabledDates" :is-dark="isDark" />
        </div>
        <div class="mb-4">
